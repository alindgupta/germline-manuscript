...
\begin{doublespacing}
  \begin{linenumbers}
    ...
    we sought to investigate the cause of defects in axoneme assembly in Drosophila male germ cells
    with reduced levels of \PIP{} from \citep{wei2008depletion}.
    ...
    we examined the localization of fluorescently-tagged versions of the
    ...
    We previously showed that the structure of basal bodies in \sigd{}
    from electron microscopy is normal, and that the localization of the centriolar
    ...
    is a hypomorph \citep{gervais2008pip5k}.
    ...
    and is removed from basal bodies in the earliest stages of G2 phase in the Drosophila male germline
    ...
    despite elongation of the axoneme (Figure 3A bottommost panel and Figure 1E).
    ...
    Unlike \sigd{}, the \textit{onr} mutant did not display hyperelongated TZs (Figure 4C),
    suggesting that Exo84 is dispensable for TZ maturation.

    Due to involvement of exocyst in membrane trafficking at the plasma membrane,
    we examined whether cilium-associated membranes were affected in \sigd{}
    or \textit{onr} mutants in a manner similar to \textit{dila; cby} mutants
    \citep{vieillard2016transition}.
    Whereas TZs in \sigd{} and \textit{onr} cells anchored properly
    to the plasma membrane, they were unable to maintain
    ...
    whereas
    \textit{cby; dila} and \textit{cby} mutants display hyperelongated TZs
    ...
    Nonetheless, axonemes can assemble despite the lack of a functional
    TZ or membrane association in \sigd{} cells.
    As we previously reported, these axonemes frequently exhibit aberrant
    ...
    Members of the exocyst complex, such as Sec10 and Sec6, are
    ...
    and the specimen was visualized using an epifluorescence microscope.
    ...
    These slides were transferred to ice-cold methanol for 5-10 minutes for fixation.
    ...
    from Inparanoid (version 8.0) and FlyBase (version 2.0).
    ...
    \begin{enumerate}[label={(\Alph*)}, nolistsep]
    \item GFP-tagged Unc is unable to detach from the basal body and migrate (white arrowhead) in spermatids expressing \sigd{}.
