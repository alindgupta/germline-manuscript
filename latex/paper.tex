...
\begin{doublespacing}
  \begin{linenumbers}
    ...
    using the $\beta$2-tubulin promoter.
    ...
    using Flp/FRT-based mitotic recombination and co-expressing the
   ...
   % in the Drosophila germline.
    A study by Xu \textit{et al}. showed the human PIPKI$\gamma$ to be
    essential for cilium formation
    ...
    Normally, centrioles and basal bodies consist of microtubule triplets,
    whereas the axoneme contains microtubule doublets due to the obstruction of
    the C-tubule at the TZ \citep{gottardo2013cilium}.
    Consistent with a defect in TZ barrier formation and the presence of
    microtubule triplets in axonemes in \sigd{} \citep{wei2008depletion},
    we observed that a small subset of cilia in SigD-expressing cells
    ...
    \citep{riparbelli2013unique}, further evidencing a relationship between
